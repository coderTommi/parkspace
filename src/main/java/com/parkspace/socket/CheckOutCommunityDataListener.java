...
/**
 * @Title: CheckOutCommunity.java
 * @Package com.parkspace.socket
 * <p>Description:离开小区数据处理监听</p>
 * @author sunld
 * @version V1.0.0 
 * <p>CreateDate:2017年10月13日 上午11:42:52</p>
*/

public class CheckOutCommunityDataListener <T> implements DataListener<T> {
	/**
     * 获取日志接口.
     */
    private static final Log LOG = LogFactory.getLog(CheckOutCommunityDataListener.class);
    
	private IParkingSpaceService parkingSpaceService;
	private IParkingSpaceBillService parkingSpaceBillService;
	
	public CheckOutCommunityDataListener() {
		
	}
	public CheckOutCommunityDataListener(IParkingSpaceService parkingSpaceService,
	...
	public void onData(SocketIOClient client, T data, AckRequest ackSender) throws Exception {
        ...
        SocketDataModel socketDataModel = JsonUtils.str2Object(data.toString(), SocketDataModel.class);
